...
const Technologies = ({page}) => {
    ...
    return (
        <div className="help-content-text">
            ...
            <Text>lectron is an environment for developing cross-platform desktop applications with web technologies (JavaScript, HTML and CSS).The infrastructure (backend) is coded in node.js, and the interface (frontend) is built on Chromium tools, the open source part of Google Chrome3.Electron is free, open source software developed by GitHub under the MIT license. Electron has notably helped develop the free text editors Atom from GitHub and Visual Studio Code from Microsoft.</Text>
